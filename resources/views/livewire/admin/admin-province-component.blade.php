                    ...
                    <div class="col-12">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{route('admin.province.add')}}" class="btn btn-primary float-end">Add
                                        new province</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($province as $provinces)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="{{route('admin.province.edit',['province_id'=>$provinces])}}"
                                               class="btn btn-outline-dark">Edit</a>
                                            <a wire:click="deleteProvince({{ $provinces->id }})"
                                               onclick="return confirm('Are you sure to delete?')"
                                               class="btn btn-secondary" style="margin-left: 20px">Delete</a>
